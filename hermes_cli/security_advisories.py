"""
Security advisory checker for Numbers.
...
run in environments where the rest of Numbers failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Numbers requires 3.10+ but defensive.
        return None
    try:
