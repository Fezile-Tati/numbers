"""Relay subscriber for the persisted Numbers shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Numbers counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Numbers shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
