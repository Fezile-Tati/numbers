...
Numbers gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Numbers to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Numbers needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Numbers gateway in another terminal:")
