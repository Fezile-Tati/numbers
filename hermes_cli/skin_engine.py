"""Numbers skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Numbers itself) customize the
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Numbers"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Numbers "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Numbers"
...
- ``default`` — Classic Numbers gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Numbers — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same Numbers gold.
        "colors": {
        ...
        "branding": {
            "agent_name": "Numbers",
            "welcome": "Welcome to Numbers! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Numbers ",
            "prompt_symbol": "❯",
