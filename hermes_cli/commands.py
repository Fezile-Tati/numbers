"""Slash command definitions and autocomplete for the Numbers CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of Numbers config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal Numbers works on across turns until achieved", "Session",
    ...
    CommandDef("wake", "Toggle the 'Hey Numbers' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while Numbers is working", "Configuration",
    ...
    CommandDef("update", "Update Numbers to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Numbers version", "Info", aliases=("v",),
...
# Telegram allows up to 100 BotCommands. Numbers ships ~50 built-in commands;
...
Telegram only displays a small BotCommand menu in practice.  The full Numbers
...
#     /numbers update on Slack. Demoted to free the native slot /approvals now
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Numbers or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
