"""On-demand supply-chain audit for Numbers installs.

Scans three surfaces a Numbers user actually controls and we can map to
upstream advisories without auth or extra binaries:

1. The Numbers venv (every PyPI dist via ``importlib.metadata``).
