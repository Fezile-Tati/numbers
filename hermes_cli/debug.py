"""``hermes debug`` debug tools for Numbers.
...
_CLIENT_SIDE_LOGS = {
    "desktop": (
        "written by Numbers Desktop on the machine running the app, not by this "
...
def run_debug_share(args):
    ...
    print("\nShare these links with the Numbers team for support.")
...
⚠️  --nous: This uploads your debug bundle to Nous-INTERNAL storage (AWS S3),
  ...
  • System info (OS, Python/Numbers version, provider, which API keys are
