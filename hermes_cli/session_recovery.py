"""Offline, non-destructive recovery for a damaged Numbers session database.
    ...
    try:
        ...
        if before != after:
            raise SessionRecoverySafetyError(
                ...
                "Stop every Numbers process using this profile and retry. "
                ...
                "Numbers process even after the gateway is stopped. Run the "
