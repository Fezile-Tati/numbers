"""``numbers tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'numbers tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # numbers tools list [--platform cli]
    ...
    # numbers tools disable <name...> [--platform cli]
    ...
    # numbers tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `numbers tools` runs after you pick a provider that\n"
