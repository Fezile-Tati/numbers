...
def build_acp_parser(subparsers, *, cmd_acp: Callable) -> None:
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run Numbers as an ACP (Agent Client Protocol) server",
        description="Start Numbers in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )
    ...
    acp_parser.add_argument(
        ...
        action="store_true",
        dest="acp_version",
        help="Print Numbers ACP version and exit",
    )
    acp_parser.add_argument(
        "--check",
        action="store_true",
