...
A *peer* is another Numbers gateway (any machine: homelab, Spark, Numbers
...
def build_peer_parser(subparsers) -> None:
    ...
    parser = subparsers.add_parser(
        "peer",
        help="Bot-to-bot DMs across machines (peer Numbers gateways)",
        description=(
            "Register other Numbers gateways as peers and message their agents. "
