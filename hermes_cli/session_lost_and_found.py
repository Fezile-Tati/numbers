...
``numbers sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Numbers session database.
...
# Numbers session ids are timestamps: 20260812_135332_ab12cd. This is the
