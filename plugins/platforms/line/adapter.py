"""
LINE Messaging API platform adapter for Numbers.
...
to Numbers. It deliberately ports the *strongest* idea from each into
...
def interactive_setup() -> None:
    """Minimal stdin wizard for ``numbers setup line``.
