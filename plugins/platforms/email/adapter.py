"""
Email platform adapter for the Numbers gateway.

Allows users to interact with Numbers by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # send-helper, and `numbers config show` already read. Without the
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Numbers")
