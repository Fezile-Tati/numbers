...
# ``model_tools`` import time, so ``hermes status``, ``numbers chat``, etc.
...
#     fresh "Numbers is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Numbers is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Numbers is thinking…' marker message.
        ...
        "Numbers is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Numbers is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Numbers is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Numbers is thinking…" card during any subsequent
...
def interactive_setup() -> None:
    """Walk the user through Google Chat configuration via ``numbers setup``.
...
def register(ctx) -> None:
    """Plugin entry point — called by the Numbers plugin system at startup.
    ...
    ctx.register_platform(
        ...
        install_hint="Run `numbers setup` to install Google Chat support.",
        ...
        # the "Numbers is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Numbers is thinking…' marker message "
