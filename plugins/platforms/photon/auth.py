...
Credential storage mirrors every other Numbers channel:
...
# registers Numbers as its own client_id.
...
# Default name of the project Numbers provisions for the operator.
DEFAULT_PROJECT_NAME = "Numbers"
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active Numbers profile."""
    try:
