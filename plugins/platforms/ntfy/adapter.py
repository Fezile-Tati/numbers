"""ntfy platform adapter (Numbers plugin).
...
a Numbers dependency.

This adapter ships as a Numbers platform plugin under
``plugins/platforms/ntfy/``. The Numbers plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Numbers dependency",
