...
two endpoints so a fresh Numbers install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``numbers tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `numbers tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `numbers tools` for reliable service."
            ),
        }
