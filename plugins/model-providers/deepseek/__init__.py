...
the contract that subsequent turns echo it back; combined with how Numbers
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Numbers remaps
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Numbers, so they are not listed here.
    """
