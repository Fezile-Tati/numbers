"""Ramp Router (router.com) provider plugin for Numbers.
...
router = RouterProfile(
    ...
    base_url=_base_url(),
    auth_type="api_key",
    # Identify Numbers traffic to the gateway (Router attributes coding-agent
    ...
    default_headers={"User-Agent": f"Numbers-Agent/{_HERMES_VERSION}"},
