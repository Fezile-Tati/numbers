"""Meta Model API (Muse Spark) provider plugin for Numbers.
...
Bundled from https://github.com/albertodepaola/hermes-meta-provider. Numbers'
...
def _resolve_effort(reasoning_config: dict | None) -> str:
    """Map Numbers' reasoning_config to a Meta-safe ``reasoning_effort`` value.
