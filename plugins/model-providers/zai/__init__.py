...
request omits ``thinking``.  Numbers' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Numbers reasoning
...
(per Z.AI / BigModel docs).  Numbers' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Numbers reasoning effort onto GLM's native vocabulary.
