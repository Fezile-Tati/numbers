...
# When the user hasn't picked a reasoning effort, Numbers passes
...
# ON at this effort — matching the "medium (default)" that Numbers' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Numbers' effort vocabulary onto Solar's accepted set via the
