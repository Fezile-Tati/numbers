...
def read_suppressed_names() -> Set[str]:
    ...
    what makes pruning a built-in durable: without it, ``numbers update`` would
...
def list_agent_created_skill_names() -> List[str]:
    ...
    for skill_md in base.rglob("SKILL.md"):
        # Skip Numbers metadata, VCS, virtualenv/dependency, and cache dirs
...
def adopt_skill(skill_name: str) -> Tuple[bool, str]:
    ...
    if is_bundled(skill_name):
        ...
        # claim Numbers' own shipped skill was agent-authored and change nothing
