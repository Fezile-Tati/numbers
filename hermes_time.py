"""
Timezone-aware clock for Numbers.
...
Invalid timezone values log a warning and fall back safely — Numbers never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Numbers requires 3.9+)
