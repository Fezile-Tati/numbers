...
class TestContractAutoRepair:
    ...
    installed driver (a state Numbers' own version-floor bump created),
...
class TestCuaEnvironmentScrubbing:
    ...
    def test_cua_session_sanitizes_provider_env_vars(self):
        ...
        The cua-driver MCP subprocess should not inherit Numbers-managed
...
class TestMcpInvocationResolution:
    ...
    the MCP subcommand doesn't require a Numbers patch.
...
class TestSessionLifecycle:
    """Surface gap (audit June 2026): Numbers never declared a cua-driver
