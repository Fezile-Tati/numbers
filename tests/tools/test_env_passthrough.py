...
class TestTerminalIntegration:
    ...
    def test_passthrough_cannot_override_provider_blocklist(self):
        ...
        Numbers provider credentials — that was the bypass where a skill
    ...
    def test_passthrough_cannot_override_internal_dynamic_secret(self):
        """A skill must NOT be able to register dynamically-named Numbers
    ...
    def test_non_hermes_api_key_still_registerable(self):
        ...
        Numbers provider credentials and must still pass through — skills
    ...
    def test_provider_blocklist_import_failure_fails_closed(self, monkeypatch):
        ...
        otherwise a skill could tunnel a Numbers credential into the
        ...
        it out of the child env. A non-Numbers key is also rejected here (the
