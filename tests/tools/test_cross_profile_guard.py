...
def fake_hermes(tmp_path, monkeypatch):
    """Build a two-profile Numbers layout and point HERMES_HOME at
...
class TestSystemPromptActiveProfile:
    ...
    def test_named_profile_line_in_prompt_text(self, fake_hermes):
        ...
        assert "Active Numbers profile" in src
        ...
        assert "Active Numbers profile: default" in src
        assert "Active Numbers profile: {active_profile}" in src
