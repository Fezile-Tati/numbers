...
def test_kanban_tools_hidden_without_env_var(monkeypatch, tmp_path):
    """Normal `numbers chat` sessions (no HERMES_KANBAN_TASK) must have
...
# restarting Numbers. These tests pin that ``board=<slug>`` argument
...
def multi_board_env(monkeypatch, tmp_path):
    """Isolated Numbers home with two distinct kanban boards seeded.
