...
class TestReapUnsupervisedGatewayOrphansMacOS:
    ...
    gateway every time Numbers Desktop opens (``numbers serve`` calls
...
class TestReapUnsupervisedGatewayOrphansWindows:
    ...
    Scheduled-Task-supervised gateway every time Numbers Desktop opens
    (``numbers serve`` calls ``_reap_unsupervised_gateway_orphans`` during
