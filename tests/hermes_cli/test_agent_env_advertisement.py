...
Numbers-specific marker, without clobbering an outer harness.

The AI_AGENT value must equal Numbers' id in the public agent-harness
...
environment does not inherit the Numbers process env, and survives the
