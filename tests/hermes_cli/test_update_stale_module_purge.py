...
sys.modules breaking the gateway auto-restart after `numbers update`.

Field failure (2026-08-20, Teknium's Linux box): `numbers update` pulled a
...
the Numbers package prefixes so later imports rebuild a self-consistent
...
def _restore_sys_modules():
    ...
    The purge under test evicts real Numbers modules from the cache; later
