...
class TestValidateCodex900kVariants:
    """`-900k` is a Numbers picker convention: valid variants come from the
...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a Numbers User-Agent.
...
class TestValidateRequestedModelNousPortalRecommendations:
    ...
    hardcoded curated catalog -- even though `numbers chat` already accepts
