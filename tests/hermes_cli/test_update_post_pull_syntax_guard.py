"""Tests for the post-pull syntax guard in ``numbers update``.
...
markers in ``hermes_cli/config.py``; users who ran ``numbers update`` in
...
# release; if a future ``numbers update`` would brick users, this test fails
# in CI first.
# ---------------------------------------------------------------------------
