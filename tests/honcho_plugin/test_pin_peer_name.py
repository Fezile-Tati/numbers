...
Under a gateway (Telegram, Discord, Slack, ...) Numbers passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to Numbers via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each Numbers profile can pin to its own unique peerName.
