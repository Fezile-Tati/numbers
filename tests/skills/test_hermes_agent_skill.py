"""The `hermes-agent` skill is what a running Numbers knows about itself.

`website/` is never packaged, so an installed Numbers has no local copy of the
...
shipped feature is invisible and the agent answers "Numbers can't do that."
"""
