...
class TestParseSchedule:
    ...
    def test_naive_iso_anchors_to_configured_tz_not_server_local(self, monkeypatch):
        """A naive ISO timestamp must be interpreted in the CONFIGURED Numbers
...
class TestNaiveScheduleTimezoneDivergence:
    ...
    become due even when the configured Numbers timezone differs from the
...
class TestJobsJsonIdKeyedMap:
    ...
    or hand edit — Numbers' own save_jobs() only ever writes a list) made
