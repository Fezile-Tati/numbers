...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Numbers never re-renders parts of this string mid-
    ...
    # user questions about Numbers itself. The skill_view() pointer is a
    ...
    # Coding posture (base Numbers, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Numbers profile the agent is running
    ...
    if active_profile == "default":
        post_workspace_parts.append(
            "Active Numbers profile: default. Other profiles (if any) live "
        ...
        post_workspace_parts.append(
            f"Active Numbers profile: {active_profile}. This session reads "
    ...
    if not agent.skip_context_files:
        ...
        # (developing Numbers). Every other surface (desktop chat panel,
        ...
        if getattr(agent, "_context_cwd_is_launch_artifact", False):
            ...
            # then reject Numbers's bundled contributor AGENTS.md (#97448).
            context_cwd = None
