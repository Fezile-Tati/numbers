"""Coding-context awareness — base Numbers, every interactive surface.

When the user runs Numbers inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Numbers shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Numbers should operate in its coding posture right now."""
