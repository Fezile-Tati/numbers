...
Plugins built on Numbers often need to make their own LLM calls
...
Today the only stable plugin surfaces extend an existing Numbers
...
embedded slugs, no shorthands. This mirrors Numbers' main config
...
handles every provider, fallback chain, and per-task override Numbers
supports.
"""
