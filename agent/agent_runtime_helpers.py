...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        # originate from untrusted input (X-Numbers-Session-Id header), and an
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # that are canonicalized only after Numbers sends the request. Honor its
...
def create_openai_client(agent, client_kwargs: dict, *, reason: str, shared: bool) -> Any:
    ...
    # All primary construction and recovery paths must identify Numbers to the
...
def sanitize_api_messages(messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    # provider-agnostic: Gemini reaches Numbers under many model strings and
...
def _iter_httpx_pool_objects(http_client: Any):
    ...
    Numbers' keepalive client (#10324 / ``_build_keepalive_http_client``) and
