...
def load_env_file(env_path: Path) -> Dict[str, str]:
    ...
    ``set_secret_scope``. Parses the small KEY=VALUE subset Numbers writes
    ...
    # Parse values with the canonical Numbers parser: save_env_value
