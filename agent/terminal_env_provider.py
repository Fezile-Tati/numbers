...
class TerminalEnvironmentProvider(abc.ABC):
    ...
    def cache_path_base(self) -> Optional[str]:
        """Base dir for synced Numbers cache files inside the backend."""
        return None
    ...
    def setup_instructions(self) -> List[str]:
        """Lines printed by ``numbers setup`` after this backend is selected.
    ...
    def post_setup(self) -> None:
        """Optional interactive setup hook run by ``numbers setup`` after the
