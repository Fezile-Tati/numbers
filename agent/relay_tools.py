"""Core NeMo Relay adapter for Numbers tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Numbers tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Numbers Relay tool execution cannot run on an active event-loop thread"
    )
