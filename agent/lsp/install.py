...
appropriate.  All installs go to a Numbers-owned bin staging dir,
...
def hermes_lsp_bin_dir() -> Path:
    """Return the Numbers-owned bin staging dir for LSP servers."""
...
def _install_npm(
    ...
    # PATH, so a bare which() misses the Node that Numbers installed and
