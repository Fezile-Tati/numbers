...
def _ensure_file_checkpoint(
    ...
    # which can differ from the Numbers process cwd (notably in Docker).  Resolve
...
def _flush_session_db_after_tool_progress(
    ...
    *,
    ...
    current Numbers process before the normal turn-end persistence path runs.
...
def _run_agent_tool_execution_middleware(
    ...
    *,
    ...
    """Run Relay rewrites before Numbers policy and dispatch exactly once."""
