...
# ``data:`` field before Numbers receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Numbers persists a content-less
...
# Request parameters that Numbers sends on SOME routes only, paired with the
