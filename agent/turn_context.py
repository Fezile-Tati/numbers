...
def build_turn_context(
    ...
    *,
    ...
    if (
        ...
        # Numbers only initiates compaction in "hermes" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Numbers preflight compression for codex app-server "
                "(mode=%s); Numbers will not start thread compaction here.",
    ...
    if agent._memory_manager:
        ...
        # to surface it. Rendered by Numbers (via _emit_status), so it always
