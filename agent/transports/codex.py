...
# Wire-name used when Numbers keeps client-side web_search on xAI Responses.
...
# avoids that while still dispatching through Numbers's configured provider
...
# Numbers dispatch is unaffected.
...
# Numbers's progressive-disclosure bridge registers exactly that literal
...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # xAI server-side web search vs Numbers web providers.
        #
        ...
        #    keep Numbers dispatch so ``web.backend`` / ``web.search_backend``
        ...
        kwargs = {
            # ``-900k`` large-context picker variants are Numbers-side aliases
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        if msg and msg.tool_calls:
            ...
            for tc in msg.tool_calls:
                ...
                # Undo THIS request's wire aliases before Numbers dispatch.
