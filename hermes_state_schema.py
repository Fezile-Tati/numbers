...
def schema_read_probe_statements() -> tuple:
    ...
    served an empty session list after `numbers update` until the user's
            ...
            if escalated:
                ...
                if foreign_holders:
                    logger.error(
                        ...
                        "`numbers sessions optimize-storage` with the gateway stopped. "
    ...
    def _init_schema(self):
        ...
        if row is None:
            ...
            if current_version < 23:
                ...
                # optimization is available. `numbers sessions optimize-storage`
