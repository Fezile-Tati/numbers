...
def _(rid, params: dict) -> dict:
                ...
                try:
                    ...
                    if hosted or peer:
                        return _err(
                            ...
                            + "Update Numbers Desktop to continue it.",
                        )
    ...
    # over another app when they are back in Numbers.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your Numbers client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not Numbers Desktop itself.",
            ...
            "First inspect what process, if any, owns the Preview URL port. If a stale server exists, inspect its cwd and prefer that cwd over the Numbers/Desktop process cwd.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not Numbers Desktop. If it serves Numbers/Desktop UI or another unrelated app, stop that process and report failure.",
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the Numbers
