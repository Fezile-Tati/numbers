...
# from shadowing Numbers's own top-level modules.  ``hermes_bootstrap`` lives at
...
def mcp_discovery_in_flight() -> bool:
    ...
    and ``numbers dashboard`` spawn theirs via
...
def main():
    ...
    # Live-apply skins Numbers activates mid-conversation.
