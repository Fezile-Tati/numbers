...
Numbers (see website/docs/getting-started/platform-support.md). The
...
Numbers package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    ...
    "Numbers is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the Numbers Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
