...
This is an additive Numbers extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Numbers head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Numbers DB session id
