...
async def _handle_runs(
    ...
    *,
    ...
    # ``X-Numbers-Session-Key``.  Falling straight through to ``run_id``
                ...
                with self._profile_scope(request_profile):
                    try:
                        ...
                        session_tokens = self._bind_api_server_session(
                            ...
                            # X-Numbers-Session-Id equivalent) exactly like
    ...
    response_headers = (
        {"X-Numbers-Session-Key": gateway_session_key} if gateway_session_key else {}
    )
    return web.json_response(
