...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Numbers session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Numbers session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Numbers agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Numbers to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Numbers gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Numbers session in it",
