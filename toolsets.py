...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "or XAI_API_KEY). Off by default; enable in `numbers tools` → "
            "X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    ...
    "video_gen": {
        "description": (
            ...
            "``numbers tools`` → Video Generation."
        ),
    ...
    # Coding posture (base Numbers — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Numbers toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-cron": {
        ...
        # core tools users see interactively — then `numbers tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hermes-cli; gated by `numbers tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with Numbers via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with Numbers via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
