#!/usr/bin/env python3
"""Build the Numbers Model Catalog — a centralized JSON manifest of curated models.
...
Numbers CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Numbers release.
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Numbers '
