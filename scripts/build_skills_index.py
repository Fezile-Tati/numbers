#!/usr/bin/env python3
"""Build the Numbers Skills Index — a centralized JSON catalog of all skills.
...
`numbers skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Numbers Skills Index...", flush=True)
