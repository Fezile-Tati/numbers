#!/usr/bin/env python3
"""
SWE Runner with Numbers Trajectory Format

A runner that uses Numbers-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Numbers-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Numbers-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Numbers format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Numbers-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Numbers-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Numbers Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Numbers-Agent's built-in execution environments
    and outputs trajectories in Numbers-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Numbers trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Numbers trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Numbers trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Numbers Trajectory Format")
    print("=" * 60)
